    ...
    init: function() {
        ! function() {
            $("#m_daterangepicker_1, #m_daterangepicker_1_modal").daterangepicker({
                ...
                $("#m_daterangepicker_3 .form-control").val(a.format("YYYY-MM-DD") + " / " + t.format("YYYY-MM-DD"))
            }), $("#m_daterangepicker_4, #m_daterangepicker_4a").daterangepicker({
                buttonClasses: "m-btn btn",
                applyClass: "btn-primary",
                cancelClass: "btn-secondary",
                timePicker: !0,
                ...
                $("#m_daterangepicker_4 .form-control, #m_daterangepicker_4a .form-control").val(a.format("MM/DD/YYYY h:mm A") + " / " + t.format("MM/DD/YYYY h:mm A"))

        ...
        <div class="m-grid__item m-grid__item--fluid m-wrapper">
          ...
          <div class="m-subheader ">
            <div class="d-flex align-items-center">
              <div class="mr-auto">
                <h3 class="m-subheader__title ">Data Status</h3>
              </div>
              <div>
                <span
    ...
    <!-- Begin Body -->
           ...
           <div class="row">
               <div class="col-xl-12 mb-4">
                <div class="btn btn-primary" data-toggle="modal" data-target="#exampleModalScrollable">Masukkan Data Status</div>
                </div>
            ...
            <div class="modal-body">
              <!-- Body Input -->
                                  ...
                                  <div class="form-group m-form__group row">
                                        <label id="status" class="form-control-label col-lg-3 mt-4">status</label>
                                        <div class="col-lg-9 mt-4">
                                          <input type="text" name="status" id="status" class="form-control m-input" placeholder="">
                                        </div>

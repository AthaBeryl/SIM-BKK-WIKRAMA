...
@section('title','SIMBKK | Info Sekolah')
@section('content')
<style>
.display{
    table-layout:fixed;
...
<script type="text/javascript">
  ...
  "sortable": false,
  render: function (id, type, full, meta) {
    return '<img src="/image/infosekolah/'+id+'" alt="'+id+'" height="100" width="100">';
  },
},
  {data: 'status'},
  {data: "id",

    ...
    <div class="col-xl-12 mb-4">
      ...
      <div class="col-xl-12">
        <div class="m-portlet m-portlet--mobile ">
          ...
          @foreach($data as $d)
          <form method="post" action="/editportofolio/update;{{$d->id}}" enctype="multipart/form-data" class="form-horizontal">
          {{ csrf_field() }}
            <div class="form-group m-form__group row">
              ...
              <div class="col-lg-12 mt-2 mb-4">
                <img src="/image/portofolio/{{$d->foto}}" id="previewHolder" alt=" Preview" width="150px" height="150px"/>
              </div>
              <div class="col-lg-12">

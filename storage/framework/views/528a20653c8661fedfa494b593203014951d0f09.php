          ...
          <div class="mr-auto">
            <nav class="site-navigation position-relative text-right" role="navigation">
              <ul class="site-menu main-menu js-clone-nav mr-auto d-none pl-0 d-lg-block">
                ...
                <li>
                  <a href="<?php echo e(url('login')); ?>" class="nav-link text-left">Login</a>
                </li>
                <li>
                  <a href="<?php echo e(url('/form-full-lowongan')); ?>" class="nav-link text-left">Informasi Lowongan Kerja</a>
                </li>
                <li>
                  <a href="<?php echo e(url('/form-full-sekolah')); ?>" class="nav-link text-left">Informasi Sekolah</a>
                </li>
                <li>
...
<?php /**PATH D:\produktif\SIM-BKK-WIKRAMA\resources\views/layouts/landing.blade.php ENDPATH**/ ?>
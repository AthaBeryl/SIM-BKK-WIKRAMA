<?php $__env->startSection('title','SMK WIKRAMA BOGOR'); ?>
...
<div class="card card-image" style="background-image: url(landing/images/bg1.jpg);height:500px;">
  <div class="text-white text-center rgba-stylish-strong py-5 px-4 mt-6">
    ...
    <a href="<?php echo e(route('login')); ?>" class="btn peach-gradient hover-login">Login</a>
                              ...
                              <div class="row">
                                ...
                                <div class="col-md-12">
                                  <div class="post-entry-2 d-flex bg-light">
                                    ...
                                    <div class="contents">
                                      <h2><a href="<?php echo e(url('/form-single-lowongan')); ?>">Dibutuhkan Lowongan Pekerjaan Administrasi Perkantoran</a></h2>
                                      <div class="post-meta">
                                  ...
                                  <div class="post-entry-2 d-flex">
                                    <div class="thumbnail zoom" style="border-radius:10px;background-image: url('landing/images/img_v_4.jpg')"></div>
                                    <div class="contents">
                                  ...
                                  <p>
                                        <a href="<?php echo e(url('/form-full-lowongan')); ?>" class="more">Lainnya<span class="icon-keyboard_arrow_right"></span></a>
                                      </p>
                          ...
                          <div class="row">
                            ...
                            <div class="col-md-12">
                              <div class="post-entry-2 d-flex bg-light">
                                <div class="thumbnail zoom" style="border-radius:10px;background-image: url('landing/images/img_v_1.jpg')"></div>
                                <div class="contents">
                                <h2><a href="<?php echo e(url('/form-single-sekolah')); ?>">Hari ini SMK WIKRAMA mendapatkan penghargaan nobel</a></h2>
                                  <div class="post-meta">
                                   <p>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Eum illo aspernatur tempora natus eligendi similique? Cupiditate a repudiandae quam magnam, placeat, ipsa temporibus natus ab, maiores deleniti dolorum accusamus corporis!</p>
                                    <span class="date-read">Jun 14 <span class="mx-1">&bullet;</span> 3 min read <span class="icon-star2"></span></span>
                                  </div>
                              ...
                              <div class="post-entry-2 d-flex">
                                <div class="thumbnail zoom" style="border-radius:10px;background-image: url('landing/images/img_v_4.jpg')"></div>
                                <div class="contents">
                                  <h2><a href="#">Selama Virus COVID-19 SMK WIKRAMA melakukan penyuluhan sosialisasi</a></h2>
                                  <div class="post-meta">
                                    <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Voluptates magni unde molestiae nisi sunt, quidem aperiam quis iure quasi et autem repellendus amet sequi, possimus praesentium dolores fuga facere quas!</p>
                                    <span class="date-read">Jun 14 <span class="mx-1">&bullet;</span> 3 min read <span class="icon-star2"></span></span>
                                  </div>
                              ...
                              <div class="post-entry-2 d-flex">
                                <div class="thumbnail zoom" style="border-radius:10px;background-image: url('landing/images/img_v_3.jpg')"></div>
                                <div class="contents">
                                  <h2><a href="#"> SMK WIKRAMA menerapkan sistem moving class </a></h2>
                                  <div class="post-meta">
                                    <p>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Praesentium, culpa excepturi incidunt dolore totam nesciunt consectetur odit, eaque obcaecati, quidem porro voluptates! Dolores, ipsum? Hic voluptatum sunt sapiente tenetur vel.</p>
                                    <span class="date-read">Jun 14 <span class="mx-1">&bullet;</span> 3 min read <span class="icon-star2"></span></span>
                                  </div>
                              ...
                              <p>
                                    <a href="<?php echo e(url('/form-full-sekolah')); ?>" class="more">Lainnya<span class="icon-keyboard_arrow_right"></span></a>
                                  </p>
...
<?php echo $__env->make('layouts.landing', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\~LENOVO~\Documents\produktif\SIM-BKK-WIKRAMA\resources\views/landing/index.blade.php ENDPATH**/ ?>
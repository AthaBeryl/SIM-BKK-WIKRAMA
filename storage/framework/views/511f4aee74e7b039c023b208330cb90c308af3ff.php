      ...
      <div class="row">
        <div class="col-lg-8 single-content">
          ...
          <div class="row">
            ...
            <a href="<?php echo e(url('/')); ?>" class= "btn btn-outline-primary mt-2 " style="border-radius:10px!IMPORTANT;">Kembali<a>
          </div>
            </div>
          </div>
        </div>
...
<?php echo $__env->make('layouts.landing', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\~LENOVO~\Documents\produktif\SIM-BKK-WIKRAMA\resources\views/landing/form-single-lowongan.blade.php ENDPATH**/ ?>